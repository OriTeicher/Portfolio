...
export default function BulletSVG(props: SvgProps) {
     return (
          <svg fill={props.color} width={props.size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
               <g>
                    <g>
                         <path
                              d="M508.416,3.582c-3.736-3.735-9.418-4.647-14.135-2.27l-13.115,6.607C435.394,30.98,393.802,60.43,357.4,95.519
